...
class MainActivity : AppCompatActivity() {
    ...
    private fun setListeners() {
        ...
        val cons : View = findViewById(R.id.red_button)
        val red : View = findViewById(R.id.red_button)
        val yellow : View = findViewById(R.id.yellow_button)
        val green : View = findViewById(R.id.green_button)
